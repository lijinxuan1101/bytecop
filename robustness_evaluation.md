...
AUC drops **0.0084** from clean to the mean of transformed images. Ranking (AUC / AP) stays high; operating-point Acc / F1 drop more because the 0.5 threshold is conservative (clean precision 0.997, recall 0.881).
